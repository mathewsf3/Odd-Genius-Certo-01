...
describe('Models Integration with Existing Services', () => {
    let matchAnalysisService;
    beforeEach(() => {
        matchAnalysisService = new MatchAnalysisService_1.MatchAnalysisService();
    });
    describe('MatchAnalysisService Integration', () => {
        ...
        it('should be compatible with MatchAnalysisResult interface', () => {
            ...
            expect((_a = mockAnalysisResult.data) === null || _a === void 0 ? void 0 : _a.selectedMatch).toBeDefined();
            expect((_b = mockAnalysisResult.data) === null || _b === void 0 ? void 0 : _b.analytics).toBeDefined();
            expect((_c = mockAnalysisResult.metadata) === null || _c === void 0 ? void 0 : _c.dataSource).toBe('footystats-api');
        });
    ...
    describe('Backwards Compatibility', () => {
        ...
        it('should allow gradual migration from any types to DTOs', () => {
            ...
            const typedMatch = Object.assign(Object.assign({}, legacyMatch), { homeGoalCount: 2, awayGoalCount: 1, totalGoalCount: 3, date_unix: 1640995200 });
