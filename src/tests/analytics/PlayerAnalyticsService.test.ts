...
describe('👤 PlayerAnalyticsService Tests', () => {
  ...
  describe('📊 Player Performance Analysis', () => {
    it('should analyze player performance with basic options', async () => {
      const playerId = 1; // Example player ID

      const result = await service.analyzePlayerPerformance(playerId, {
        includeForm: false,
    ...
    it('should analyze player performance with full options', async () => {
      const playerId = 1;
    ...
    it('should handle invalid player ID gracefully', async () => {
      const result = await service.analyzePlayerPerformance(-1);
  ...
  describe('🏁 Referee Performance Analysis', () => {
    it('should analyze referee performance with basic options', async () => {
      const refereeId = 1; // Example referee ID

      const result = await service.analyzeRefereePerformance(refereeId, {
        includeImpact: false,
    ...
    it('should analyze referee performance with full options', async () => {
      const refereeId = 1;
    ...
    it('should handle invalid referee ID gracefully', async () => {
      const result = await service.analyzeRefereePerformance(-1);
  ...
  describe('🏆 League Players Analysis', () => {
    it('should analyze all players in a league', async () => {
      const seasonId = 1; // Example season ID

      const result = await service.analyzeLeaguePlayers(seasonId, {
        maxPlayers: 10,
    ...
    it('should handle invalid season ID for players', async () => {
      const result = await service.analyzeLeaguePlayers(-1);
  ...
  describe('🏁 League Referees Analysis', () => {
    it('should analyze all referees in a league', async () => {
      const seasonId = 1;

      const result = await service.analyzeLeagueReferees(seasonId, {
        includeImpact: true,
        includeTeamEffects: false
      });
    ...
    it('should handle invalid season ID for referees', async () => {
      const result = await service.analyzeLeagueReferees(-1);
  ...
  describe('⚔️ Player Comparison', () => {
    it('should compare two players', async () => {
      ...
      const result = await service.comparePlayers(player1Id, player2Id);
    ...
    it('should handle invalid player IDs for comparison', async () => {
      const result = await service.comparePlayers(-1, -2);
  ...
  describe('🔄 Caching Integration', () => {
    it('should cache player analysis results', async () => {
      const playerId = 1;

      // First call - should fetch from API
      const result1 = await service.analyzePlayerPerformance(playerId);
      ...
      const result2 = await service.analyzePlayerPerformance(playerId);
  ...
  describe('⚡ Performance Testing', () => {
    it('should handle multiple concurrent player analyses', async () => {
      ...
      results.forEach((result, index) => {
        expect(result.success).toBeDefined();
        expect(result.metadata).toBeDefined();
        console.log(`✅ Concurrent player analysis ${index + 1}: ${result.metadata?.processingTime}ms`);
      });
  ...
  describe('📊 Data Quality Validation', () => {
    it('should validate player analysis data quality', async () => {
      const result = await service.analyzePlayerPerformance(1);
