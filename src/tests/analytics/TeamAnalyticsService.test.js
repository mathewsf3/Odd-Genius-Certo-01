...
describe('👥 TeamAnalyticsService Tests', () => {
    let service;
    beforeEach(() => {
        service = new TeamAnalyticsService_1.TeamAnalyticsService({
            enableCaching: true,
    ...
    describe('📊 Team Performance Analysis', () => {
        it('should analyze team performance with basic options', () => __awaiter(void 0, void 0, void 0, function* () {
            const teamId = 1; // Example team ID
            const result = yield service.analyzeTeamPerformance(teamId, {
                includeForm: false,
        ...
        it('should analyze team performance with full options', () => __awaiter(void 0, void 0, void 0, function* () {
            const teamId = 1;
            const result = yield service.analyzeTeamPerformance(teamId, {
                includeForm: true,
        ...
        it('should handle invalid team ID gracefully', () => __awaiter(void 0, void 0, void 0, function* () {
            const result = yield service.analyzeTeamPerformance(-1);
    ...
    describe('⚔️ Team Comparison', () => {
        it('should compare two teams', () => __awaiter(void 0, void 0, void 0, function* () {
            const homeTeamId = 1;
            const awayTeamId = 2;
            const result = yield service.compareTeams(homeTeamId, awayTeamId, {
                includeH2H: false,
                includeForm: false
            });
            expect(result.success).toBeDefined();
        ...
        it('should compare teams with H2H and form analysis', () => __awaiter(void 0, void 0, void 0, function* () {
            const homeTeamId = 1;
            const awayTeamId = 2;
            const result = yield service.compareTeams(homeTeamId, awayTeamId, {
                includeH2H: true,
        ...
        it('should handle invalid team IDs for comparison', () => __awaiter(void 0, void 0, void 0, function* () {
            const result = yield service.compareTeams(-1, -2);
            expect(result.success).toBe(false);
            expect(result.error).toBeDefined();
    ...
    describe('🏆 League Teams Analysis', () => {
        it('should analyze all teams in a league', () => __awaiter(void 0, void 0, void 0, function* () {
            const seasonId = 1; // Example season ID
            const result = yield service.analyzeLeagueTeams(seasonId, {
                includeForm: true,
                includeStrengthRating: true
            });
            expect(result.success).toBeDefined();
        ...
        it('should handle invalid season ID', () => __awaiter(void 0, void 0, void 0, function* () {
            const result = yield service.analyzeLeagueTeams(-1);
            expect(result.success).toBe(false);
            expect(result.error).toBeDefined();
    ...
    describe('📈 Team Form Trends', () => {
        it('should get team form trends', () => __awaiter(void 0, void 0, void 0, function* () {
            const teamId = 1;
            const matchCount = 10;
            const result = yield service.getTeamFormTrends(teamId, matchCount);
            expect(result.success).toBeDefined();
            expect(result.metadata).toBeDefined();
    ...
    describe('🔄 Caching Integration', () => {
        it('should cache team analysis results', () => __awaiter(void 0, void 0, void 0, function* () {
            var _a, _b, _c, _d;
            const teamId = 1;
            // First call - should fetch from API
            const result1 = yield service.analyzeTeamPerformance(teamId);
            ...
            const result2 = yield service.analyzeTeamPerformance(teamId);
    ...
    describe('⚡ Performance Testing', () => {
        it('should handle multiple concurrent team analyses', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            results.forEach((result, index) => {
                ...
                expect(result.success).toBeDefined();
                expect(result.metadata).toBeDefined();
                console.log(`✅ Concurrent team analysis ${index + 1}: ${(_a = result.metadata) === null || _a === void 0 ? void 0 : _a.processingTime}ms`);
            });
    ...
    describe('📊 Data Quality Validation', () => {
        it('should validate team analysis data quality', () => __awaiter(void 0, void 0, void 0, function* () {
            const result = yield service.analyzeTeamPerformance(1, {
                includeForm: true,
                includeStrengthRating: true
            });
